...
<div class="container">
    <div class="mt10">
        <div class="row mt20">
            <div class="col-md-12">
                <p class="inline pull-right forum-back"><a class="btn btn-primary" href="<?= $this->Html->url(array('controller' => 'message', 'action' => 'index')) ?>"><i class="fa fa-undo" aria-hidden="true"></i> <?= $Lang->get('FORUM__BACKTO__MSG'); ?></a></p>
            </div>
            <div class="col-md-12">
                <form action="" method="post">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?= $Lang->get('FORUM__PHRASE__SENDMYMSG'); ?></button>
                    </div>
                </form>
            </div>
        </div>
