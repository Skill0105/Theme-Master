                ...
                <div class="p15">
                    ...
                    <?php if($active['socialnetwork']): ?>
                        <div class="forum-bloc mt15">
                            <div class="forum-bloc-header p15">
                                <h3 class="forum-h3">
                                    <i class="fa fa-users" aria-hidden="true"></i> <?= $Lang->get('FORUM__SOCIAL__NETWORK'); ?>
                                </h3>
                ...
                <div class="p15">
                    <div class="forum-bloc p15">
                        ...
                        <?php if(isset($_SESSION['user']) && $_SESSION['user'] == $id): ?>
                            <a style="margin-left: 5px;" class="btn btn-primary pull-right inline" href="<?= $this->Html->url('/user/'.$slug.'.'.$id.'/edit') ?>"><i class="fa fa-pencil" aria-hidden="true"></i> <?= $Lang->get('GLOBAL__EDIT'); ?></a>
                        <?php endif; ?>
                        <div>
