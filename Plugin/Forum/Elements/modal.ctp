                ...
                <div class="modal-body">
                    <div class="row">
                        <?php if($perms['FORUM_TOPIC_LOCK']): ?>
                            <div class="col-md-4 text-center">
                                <?php if($topic['Topic']['lock']): ?>
                                    <a href="<?= $this->Html->url('/forum/action/topic/unlock/'.$topic['Topic']['id_topic']); ?>" class="btn btn-primary mt30">
                                        <i class="fa fa-unlock" aria-hidden="true"></i> <?= $Lang->get('FORUM__UNLOCK'); ?>
                                    </a>
                                <?php else: ?>
                                    <a href="<?= $this->Html->url('/forum/action/topic/lock/'.$topic['Topic']['id_topic']); ?>" class="btn btn-primary mt30">
                        ...
                        <?php if($perms['FORUM_TOPIC_STICK']): ?>
                            <div class="col-md-4 text-center">
                                <?php if($topic['Topic']['stick']): ?>
                                    <a href="<?= $this->Html->url('/forum/action/topic/unstick/'.$topic['Topic']['id_topic']); ?>" class="btn btn-primary mt30">
                                        <i class="fa fa-paperclip" aria-hidden="true"></i> <?= $Lang->get('FORUM__UNSTICK'); ?>
                                    </a>
                                <?php else: ?>
                                    <a href="<?= $this->Html->url('/forum/action/topic/stick/'.$topic['Topic']['id_topic']); ?>" class="btn btn-primary mt30">
                        ...
                        <?php if($perms['FORUM_TOPIC_DELETE']): ?>
                            <div class="col-md-4 text-center">
                                <a href="<?= $this->Html->url('/forum/action/topic/delete/'.$topic['Topic']['id_topic']); ?>" class="btn btn-primary mt30">
                        ...
                        <div class="row mt20">
                            <form action="<?= $this->Html->url('/forum/action/topic/rename/'.$topic['Topic']['id_topic']); ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" value="<?= h($topic['Topic']['name']); ?>" name="name" class="form-control" style="height: 35px;"/>
                                    </div>
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="row mt20">
                            <form action="<?= $this->Html->url('/forum/action/topic/moove/'.$topic['Topic']['id_topic']); ?>" method="post">
                                <div class="form-group">
                                    <input name="data[_Token][key]" value="<?= $csrfToken ?>" type="hidden" />
                                    <div class="col-md-10">
                                        <select name="forum" class="form-control" style="color: #fff;background-color: #111;border: 1px solid #fff;border-radius: 0px;">
