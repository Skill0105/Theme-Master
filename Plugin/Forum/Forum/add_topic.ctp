        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-sm-12">
                ...
                <form method="post" action="<?= $this->here ?>">
                    ...
                    <div class="forum-forum">
                        <div class="forum-other-header">
                            <p class="forum-forum-title">
                                <i class="fa fa-font" aria-hidden="true"></i> <?= $Lang->get('FORUM__TITLE__TOPIC'); ?>
                            </p>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="collapse mt20" id="collapseInfo">
                                        <div class="alert alert-warning" role="alert">
                                            <strong><?= $Lang->get('FORUM__WARNING!'); ?></strong> <?= $Lang->get('FORUM__PHRASE__PAGE__ADDTOPIC_1'); ?>
                                        </div>
                                    </div>
                                    <div class="input-group">
                                        <input name="title" class="form-control"
                                               placeholder="<?= $Lang->get('FORUM__TITLE__TOPIC'); ?>"/>
                                        <div class="input-group-btn">
                                            <button style="height: 60px;" type="button" class="btn btn-default"
                                                    aria-label="Help" data-toggle="collapse" data-target="#collapseInfo"
                                                    aria-expanded="false" aria-controls="collapseInfo"><span
                    ...
                    <div class="forum-forum">
                        <div class="forum-other-header">
                            <p class="forum-forum-title"><i class="fa fa-cog"
                                                            aria-hidden="true"></i> <?= $Lang->get('FORUM__SETTINGS'); ?>
                            </p>
                        </div>
                        <div class="forum-category">
                            <div class="row">
                                        ...
                                        <div class="checkbox">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="stick"
                                                       value="stick"/> <?= $Lang->get('FORUM__TOPIC__STICK__ALT'); ?>
                                            </label>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <div class="checkbox">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="lock"
                                                       value="lock"/> <?= $Lang->get('FORUM__TOPIC__LOCK__ALT'); ?>
                                            </label>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="forum-forum">
                        <div class="forum-other-header">
                            <p class="forum-forum-title"><i class="fa fa-cog"
                                                            aria-hidden="true"></i> <?= $Lang->get('FORUM__TAGS'); ?>
                            </p>
                        </div>
                        <div class="forum-category">
                            <div class="row">
                                    ...
                                    <?php if (!empty($tags)): ?>
                                        <?php if ($params['isEdit']['tag']): ?>
                                            <?php foreach ($tags as $key => $tag): ?>
                                                <span style="background-color: #<?= $tag['Tag']['color']; ?>"
                                                      class="labeltag"><input type="checkbox" class="middle"
                                                                              value="<?= $tag['Tag']['id']; ?>"
                                                                              name="tag-<?= $tag['Tag']['id']; ?>"/>
                                                    <?php if (!empty($tag['Tag']['icon'])): ?>
                                                        <i class="fa fa-<?= $tag['Tag']['icon']; ?>"
                                                           aria-hidden="true"></i>
                                                    <?php endif; ?>
                                                    <?= $tag['Tag']['name']; ?>
                                                    </span>
                    ...
                    <div class="text-center">
                        <button type="submit" id="submit_update" class="btn btn-primary"><i class="fa fa-plus"
                                                                                            aria-hidden="true"></i> <?= $Lang->get('FORUM__SEND__MYTOPIC'); ?>
                        </button>
                    </div>
                </form>
            </div>
